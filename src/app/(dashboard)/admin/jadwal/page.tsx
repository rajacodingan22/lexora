...
import {
  Plus, Loader2, X, Calendar, Clock, LinkIcon, Video, MapPin, Users, Search,
...
const emptyForm: SessionForm = {
  course_id: '', teacher_id: '', title: '', starts_at: '', provider: 'zoom', meeting_link: '', duration_minutes: '60',
}
...
export default function AdminJadwalPage() {
  ...
  useEffect(() => { Promise.all([fetchSessions(), fetchCourses(), fetchTeachers()]) }, [])
  ...
  function openEdit(session: Session) {
    setForm({
      course_id: session.course_id, teacher_id: session.teacher_id, title: session.title,
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-end gap-2 pt-2">
                    ...
                    <Button onClick={handleSave} loading={saving} disabled={!form.title || !form.starts_at || (!editingSession && (!form.course_id || !form.teacher_id))}>
