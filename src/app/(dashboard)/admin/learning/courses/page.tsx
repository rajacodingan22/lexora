  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        <h1 className="text-2xl font-bold text-on-surface">{t('learning.title')}</h1>
        <p className="text-sm text-on-surface-variant">{t('learning.subtitle')}</p>
      </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {courses.map((c) => (
            ...
            >
              ...
              >
                <div className="relative h-36 w-full overflow-hidden rounded-t-xl bg-surface-container-low">
                  {c.image_url ? (
                ...
                <CardHeader className="pb-2">
                  <div className="flex items-start justify-between gap-2">
                    <h3 className="font-semibold text-on-surface line-clamp-2">{courseTitle(c)}</h3>
                  </div>
