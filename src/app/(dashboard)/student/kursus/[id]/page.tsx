...
import {
  Video, Calendar, Download, FileText, Clock, CheckCircle,
  MessageCircle, BookOpen, Users, Globe, BarChart3, Loader2,
  ExternalLink, Headphones, File, FileSpreadsheet, Link2,
  MessageSquare, Plus, X, Send, FileText as FileTextIcon,
  ChevronDown, ChevronUp, Lock, Pin,
...
export default function CourseDetailPage() {
  ...
  async function fetchAll() {
    ...
    try {
      ...
      const [courseRes, ctRes, sessionsRes, materialsRes, assignmentsRes, quizzesRes, discussionsRes, enrollmentRes, placementRes, scheduleRes] = await Promise.all([
        supabase
          .from('courses')
