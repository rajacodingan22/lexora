  ...
  const testimonials = [
    {
      ...
      role: t('public.home.testimonialRole1'),
      text: testimonialText('public.home.testimonial1'),
      avatar_url: null,
      rating: 5,
      sort_order: 1,
      is_active: true,
    ...
    },
    {
      id: '2',
      name: 'Andika Pratama',
      role: t('public.home.testimonialRole2'),
      text: testimonialText('public.home.testimonial2'),
      avatar_url: null,
      rating: 5,
      sort_order: 2,
      is_active: true,
    ...
    },
    {
      id: '3',
      name: 'Maya Indah',
      role: t('public.home.testimonialRole3'),
      text: testimonialText('public.home.testimonial3'),
      avatar_url: null,
      rating: 5,
      sort_order: 3,
      is_active: true,
      ...
      <main className="min-h-screen">
        <div className="pt-4">
          <HeroSection
            ...
            heroData={{
              title: t('public.home.heroTitle'),
              subtitle: t('public.home.heroSubtitle'),
              ctaText: t('public.home.heroCta'),
              ctaLink: '/daftar',
              featurePills: [],
            }}
          />
