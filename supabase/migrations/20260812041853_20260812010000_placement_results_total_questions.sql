...
where pr.test_id = t.test_id
  and pr.total_questions is null;
...
begin
  ...
  insert into public.placement_results (user_id, test_id, answers, score, provisional_level, total_questions, completed_at)
  values (v_user_id, v_test_id, p_answers, v_score, v_level, v_total, now()) returning * into v_row;
